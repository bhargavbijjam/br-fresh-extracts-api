...
const translations = {
  en: {
    ...
    'login.firebaseMissing': 'Firebase is not configured yet. Add your Firebase keys and try again.',
  ...
  hi: {
    ...
    'login.firebaseMissing': 'Firebase कॉन्फ़िगर नहीं है। कृपया अपनी Firebase keys जोड़ें।',
  ...
  te: {
    ...
    'login.firebaseMissing': 'Firebase కాన్ఫిగర్ కాలేదు. మీ Firebase keys జోడించండి.',
