...
const defaultData = {
  ...
  products: [
    { id: 'p1', name: 'Kashmiri Saffron', category: 'Spices', price: 899, weight: '2g', image: 'https://images.unsplash.com/photo-1625944525533-473f1a3d54e7?w=400&q=80', description: 'Pure A++ grade Kashmiri saffron — deeply aromatic with a rich golden hue.', featured: true },
    { id: 'p2', name: 'Darjeeling Green Tea', category: 'Teas', price: 349, weight: '100g', image: 'https://images.unsplash.com/photo-1556679343-c7306c1976bc?w=400&q=80', description: 'First flush green tea from the misty slopes of Darjeeling.', featured: true },
    { id: 'p3', name: 'A2 Cow Ghee', category: 'Ghee & Oils', price: 799, weight: '500ml', image: 'https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?w=400&q=80', description: 'Traditionally bilona-churned from grass-fed A2 cow milk.', featured: true },
    { id: 'p4', name: 'Raw Forest Honey', category: 'Sweeteners', price: 449, weight: '300g', image: 'https://images.unsplash.com/photo-1558642452-9d2a7deb7f62?w=400&q=80', description: 'Unheated, unfiltered wild honey from Himalayan forests.', featured: true },
    { id: 'p5', name: 'Organic Turmeric', category: 'Spices', price: 199, weight: '200g', image: 'https://images.unsplash.com/photo-1615485500704-8e990f9900f7?w=400&q=80', description: 'High-curcumin Lakadong turmeric — lab-tested for purity.', featured: false },
    { id: 'p6', name: 'Ashwagandha Chai', category: 'Teas', price: 299, weight: '50g', image: 'https://images.unsplash.com/photo-1563822249366-3efb23b8e0c9?w=400&q=80', description: 'Adaptogenic blend with ashwagandha, ginger & cardamom.', featured: false },
    { id: 'p7', name: 'Cold-Press Coconut Oil', category: 'Ghee & Oils', price: 399, weight: '500ml', image: 'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=400&q=80', description: 'Wood-pressed virgin coconut oil, unrefined & full of flavour.', featured: false },
    { id: 'p8', name: 'Organic Jaggery', category: 'Sweeteners', price: 249, weight: '500g', image: 'https://images.unsplash.com/photo-1604413191066-4dd20bedf486?w=400&q=80', description: 'Sun-dried sugarcane jaggery — no chemicals, no bleach.', featured: false },
  ],
  testimonials: [
