...
export default function AdminCategories() {
  const { store, addCategory, updateCategory, deleteCategory } = useStore();
  ...
  const openEdit = (cat) => { setForm({ name: cat.name, description: cat.description, image: cat.image, icon: cat.icon }); setEditing(cat.id); setShowForm(true); };
