    ...
    return (
      <div className="min-h-screen bg-cream flex items-center justify-center pt-20">
        <div className="text-center p-8 max-w-sm">
          ...
          <p className="text-warm-brown/60 text-sm mb-8">Add some organic goodness to get started.</p>
      ...
      <div className="max-w-6xl mx-auto px-6 py-10">
        <AnimatedSection>
          <div className="flex items-center gap-3 mb-8">
            ...
            <h1 className="font-serif text-3xl md:text-4xl text-forest-700">Your Cart</h1>
            <span className="text-sm text-warm-brown/50 font-sans">({items.length} item{items.length > 1 ? 's' : ''})</span>
          </div>
        </AnimatedSection>
                ...
                <div className="bg-white rounded-2xl p-5 border border-sand-200 flex gap-4 shadow-sm">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2">
                      <div>
                        <p className="text-xs text-terra-500 font-medium mb-0.5">{item.category}</p>
