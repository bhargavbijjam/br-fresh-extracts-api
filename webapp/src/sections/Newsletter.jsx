      ...
      <div className="max-w-3xl mx-auto px-6 text-center">
        <AnimatedSection>
          ...
          <p className="text-warm-brown/65 text-base mb-8 leading-relaxed">
            Join our community for seasonal recipes, farm stories, exclusive offers and new product launches.
          </p>
          ...
          <p className="mt-4 text-xs text-warm-brown/40">No spam, ever. Unsubscribe anytime.</p>
        </AnimatedSection>
      </div>
    </section>
  );
